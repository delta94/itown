                ...
                {insets => <View style={[styles.container,{backgroundColor: apColors.appBg,paddingBottom: insets.bottom,paddingLeft: insets.left,paddingRight: insets.right}]}>
                    ...
                    >
                        ...
                        <View style={[styles.singleContent,{backgroundColor: apColors.appBg,}]}>
                            ...
                            { calContent !== '' && <HTML html={calContent} tagsStyles={htmlTagsStyles} 
                            ...
                            <View style={{marginTop: 10,}}>
                                    ...
                                    {phone != '' && <View style={styles.contactItem}>
                                        ...
                                        <TouchableOpacity onPress={()=>_self._sendSMS()}><TextRegular >{phone}</TextRegular></TouchableOpacity>
                                    </View>}
                            ...
                            <LHostedBy post={_self.props.listing} apColors={apColors} sendMail={_self._sendEmail} sendSMS={_self._sendSMS}/>
